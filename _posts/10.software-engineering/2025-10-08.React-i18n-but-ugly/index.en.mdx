...
- I can easily sacrifice plural rules, time/number formatting for less dependencies — the website is mostly static
- I don’t outsource translations; I don’t need detachable catalogs
...
- **scope the requirements**, which allows for the creation of a minimalistic tailor-made solution, and
- **start prototyping**. Note that I don't try to design everything upfront.
...
3. Leverage TypeScript’s type system to express the complex i18n structure.
...
- Scoping the requirements and not trying to be smart and future-proof helps with minimalistic solutions — YAGNI
