...
const about = {
  name: {
    en: 'I build High-Scale Software',
    uk: 'Я будую високонавантажені системи',
  },
  subhead: {
    en: [
      `
    ...
    uk: [
      `
      Маю досвід створення бекендів на 30 мільйонів користувачів (з RDBMS) або real-time інфраструктури для 3000 одночасних speech-to-text потоків.
      Я читаю код частіше за документацію і вірю метрикам більше, ніж best practices.
      Проєктування високонавантажених систем починається з розуміння що саме відбувається під капотом у заліза, ядра і далі...
      `,
      `
  ...
  linkedinCta: {
    ...
    uk: `Напишіть в LinkedIn`,
  },
};

export function translateAbout(lang: Lang) {
  return {
    name: about.name[lang],
    items: {
      subhead: about.subhead[lang],
      proofs: about.proofs[lang],
      cta: about.cta[lang],
      linkedinCta: about.linkedinCta[lang],
    },
  };
}

export type AboutContent = ReturnType<typeof translateAbout>;
