export const tokenizerStrings = {
  en: {
    ...
    guess: {
      question:
        "Add one rare word: 'Why is the sky unbelievably blue?'. How many pieces will 'unbelievably' shatter into?",
      options: ['1', '3', '6', '12'],
      correctIndex: 2,
      payoff:
        "actually 6, because rare words don't get their own vocabulary entry, so BPE stitches them from smaller learned pieces.",
    },
  },
  uk: {
    ...
    guess: {
      question:
        "Додамо одне рідкісне слово: 'Why is the sky unbelievably blue?'. На скільки шматків розлетиться 'unbelievably'?",
      options: ['1', '3', '6', '12'],
      correctIndex: 2,
      payoff:
        'насправді 6, бо рідкісні слова не мають власного запису в словнику, тож BPE зшиває їх із менших вивчених шматків.',
    },
  },
} as const;
