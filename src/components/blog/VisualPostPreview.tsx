...
export default function VisualPostPreview({
  ...
  return (
    <UnstyledLink href={href} className={clsx('group block h-full', className)}>
      ...
      <div className='flex flex-col'>
        <h3 className='font-bold text-lg leading-tight group-hover:text-sky-600 dark:group-hover:text-sky-400 transition-colors'>
          {post.title}
        </h3>
